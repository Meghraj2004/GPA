...
<head>
    ...
    <style>
        ...
        .image-container2 {
            ...
            margin: 20px; /* Add margin to separate image containers horizontally */
...
function insertData(){
    ...
    $sql = "INSERT INTO users (first_name, last_name, email, phone_number, date_of_birth, gender, username, password)
    VALUES ('$first_name', '$last_name', '$email', '$phone_number', '$date_of_birth', '$gender', '$username', '$password',' $graphical_pass')";
